...
export default class QuestionFaces extends Component {
  ...
  updateState = (state) => {
    ...
    let noAnger = state.joy.value + state.sadness.value + state.disgust.value + state.fear.value
    let noFear = state.joy.value + state.sadness.value + state.anger.value + state.disgust.value
